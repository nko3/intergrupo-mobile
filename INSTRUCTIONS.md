...
~~~sh
git clone git@github.com:nko3/intergrupo-mobile.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-intergrupo-mobile --password ucUAe60JnBbSueJ1
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/intergrupo-mobile" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280538
[3]: https://github.com/nko3/intergrupo-mobile
